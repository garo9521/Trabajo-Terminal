...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.BotonAnterior.setGeometry(QtCore.QRect(30, 480, 100, 41))
        self.BotonAnterior.setObjectName(_fromUtf8("BotonAnterior"))
        self.BotonSiguient = QtGui.QPushButton(self.centralwidget)
        self.BotonSiguient.setGeometry(QtCore.QRect(150, 480, 100, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BotonAnterior.setText(_translate("MainWindow", "Region Creciente", None))
        self.BotonSiguient.setText(_translate("MainWindow", "Umbralizacion", None))
